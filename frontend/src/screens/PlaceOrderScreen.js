...
import paymentAndShipping from '../redux/slices/paymentAndShipping';
...
const PlaceOrderScreen = () => {
    ...
    const {shippingAddress, order, error, isLoading, isSuccessfull} = AddressAndShipping;
    ...
    const totalPrice = addDecimals(Number(+itemsPrice + +shippingPrice + +taxPrice).toFixed(2))
                ...
                <ListGroup variant='flush'>
                    ...
                    <ListGroup.Item>
                        ...
                        <p>
                            ...
                            {' '}{AddressAndShipping.paymentMethord}
                        </p>
                    </ListGroup.Item>
            ...
            <Col md={4}>
                <Card>
                    <ListGroup variant='flush'>
                        ...
                        <ListGroup.Item>
                            <Button className='btn-block' type='button' disabled={cart.cartItems === 0} onClick={placeOrderHandler}>
                                Proceed to checkout
                            </Button>
                        </ListGroup.Item>
                    </ListGroup>
